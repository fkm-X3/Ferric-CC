# Ferric-CC Design Document

This document describes the architecture and implementation of Ferric-CC
(forked from Claude's C Compiler). For building, usage, and status information, see
